package io.themade4.relictium.mixin.features.debug;
...
public abstract class MixinDebugHud {
    ...
    private static String getFormattedVersionText() {
        String version = RelictiumClientMod.getVersion();
    ...
    private static List<String> getChunkRendererDebugStrings() {
        RelictiumWorldRenderer renderer = RelictiumWorldRenderer.getInstanceNullable();
        if (renderer == null)
