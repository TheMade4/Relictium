package io.themade4.relictium.core.client.render;
...
import io.themade4.relictium.core.client.render.chunk.ChunkRenderManager;
import io.themade4.relictium.core.client.render.chunk.backends.multidraw.MultidrawChunkRenderBackend;
import io.themade4.relictium.core.client.render.chunk.backends.oneshot.ChunkRenderBackendOneshot;
import io.themade4.relictium.core.client.render.chunk.data.ChunkRenderData;
import io.themade4.relictium.core.client.render.chunk.format.DefaultModelVertexFormats;
...
import io.themade4.relictium.core.client.render.pipeline.context.ChunkRenderCacheShared;
...
import io.themade4.relictium.core.client.world.ChunkStatusListenerManager;
import io.themade4.relictium.common.util.ListUtil;
 ...
 */
public class RelictiumWorldRenderer implements ChunkStatusListener {
    private static RelictiumWorldRenderer instance;
     ...
     */
    public static RelictiumWorldRenderer create() {
        if (instance == null) {
            instance = new RelictiumWorldRenderer(Minecraft.getMinecraft());
        }
     ...
     */
    @Deprecated
    public static RelictiumWorldRenderer getInstance() {
        if (instance == null) {
     ...
     */
    public static RelictiumWorldRenderer getInstanceNullable() {
        return instance;
    }

    private RelictiumWorldRenderer(Minecraft client) {
        this.client = client;
    }
    ...
    public void updateChunks(Frustum frustum, float ticks, boolean hasForcedFrustum, int frame, boolean spectator) {
        ...
        this.useEntityCulling = RelictiumClientMod.options().advanced.useEntityCulling;
    ...
    private void initRenderer() {
        ...
        RelictiumGameOptions opts = RelictiumClientMod.options();
    ...
    private static ChunkRenderBackend<?> createChunkRenderBackend(RenderDevice device,
                                                                  RelictiumGameOptions options,
                                                                  ChunkVertexType vertexFormat) {
        boolean disableBlacklist = RelictiumClientMod.options().advanced.ignoreDriverBlacklist;
    ...
    private void renderTE(TileEntity tileEntity, int pass, float partialTicks, int damageProgress) {
        ...
        try {
            ...
            if(tileEntity.isInvalid()) {
                RelictiumClientMod.logger().error("Suppressing crash from invalid tile entity", e);
            } else {
                throw e;
            }
        }
