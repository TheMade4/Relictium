package io.themade4.relictium.core.client.render.chunk;
...
import io.themade4.relictium.core.client.render.RelictiumWorldRenderer;
...
import io.themade4.relictium.core.client.render.chunk.compile.ChunkBuilder;
import io.themade4.relictium.core.client.render.chunk.cull.ChunkCuller;
import io.themade4.relictium.core.client.render.chunk.cull.ChunkFaceFlags;
import io.themade4.relictium.core.client.render.chunk.cull.graph.ChunkGraphCuller;
import io.themade4.relictium.core.client.render.chunk.data.ChunkRenderBounds;
import io.themade4.relictium.core.client.render.chunk.data.ChunkRenderData;
import io.themade4.relictium.core.client.render.chunk.lists.ChunkRenderList;
import io.themade4.relictium.core.client.render.chunk.lists.ChunkRenderListIterator;
import io.themade4.relictium.core.client.render.chunk.passes.BlockRenderPass;
import io.themade4.relictium.core.client.render.chunk.passes.BlockRenderPassManager;
import io.themade4.relictium.core.client.util.math.FrustumExtended;
import io.themade4.relictium.core.client.util.math.MathChunkPos;
import io.themade4.relictium.core.client.world.ChunkStatusListener;
import io.themade4.relictium.common.util.DirectionUtil;
import io.themade4.relictium.common.util.IdTable;
import io.themade4.relictium.common.util.collections.FutureDequeDrain;
...
public class ChunkRenderManager<T extends ChunkGraphicsState> implements ChunkStatusListener {
    ...
    private final RelictiumWorldRenderer renderer;
    ...
    public ChunkRenderManager(RelictiumWorldRenderer renderer, ChunkRenderBackend<T> backend, BlockRenderPassManager renderPassManager, WorldClient world, int renderDistance) {
        ...
        this.translucencySorting = RelictiumClientMod.options().advanced.translucencySorting;
        this.translucencyBlockRenderDistance = Math.min(9216, (renderDistance << 4) * (renderDistance << 4));

        this.useBlockFaceCulling = RelictiumClientMod.options().advanced.useBlockFaceCulling;
    }
    ...
    private void setup(float ticks) {
        ...
        this.alwaysDeferChunkUpdates = RelictiumClientMod.options().performance.alwaysDeferChunkUpdates;

        if (RelictiumClientMod.options().advanced.useFogOcclusion) {
