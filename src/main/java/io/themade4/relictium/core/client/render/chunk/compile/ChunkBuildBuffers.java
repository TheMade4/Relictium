...
import io.themade4.relictium.core.client.model.vertex.buffer.VertexBufferBuilder;
import io.themade4.relictium.core.client.model.vertex.type.ChunkVertexType;
import io.themade4.relictium.core.client.render.chunk.compile.buffers.BakedChunkModelBuffers;
import io.themade4.relictium.core.client.render.chunk.compile.buffers.ChunkModelBuffers;
import io.themade4.relictium.core.client.render.chunk.compile.buffers.ChunkModelVertexTransformer;
...
import io.themade4.relictium.core.client.util.BufferSizeUtil;
import io.themade4.relictium.core.client.util.EnumUtil;
...
public class ChunkBuildBuffers {
    ...
    public void init(ChunkRenderData.Builder renderData) {
        for (int i = 0; i < this.buffersByLayer.length; i++) {
            ...
            for (ModelQuadFacing facing : ModelQuadFacing.VALUES) {
                writers[facing.ordinal()] = new ChunkModelVertexTransformer(this.vertexType.createBufferWriter(this.buffersByLayer[i][facing.ordinal()], RelictiumClientMod.isDirectMemoryAccessEnabled()), this.offset);
            }
