package io.themade4.relictium.core.client.model.quad.blender;
...
import io.themade4.relictium.core.client.util.color.ColorARGB;
import io.themade4.relictium.core.client.util.color.ColorU8;
...
public class SmoothBiomeColorBlender implements BiomeColorBlender {
    ...
    private int getBlockColor(IBlockColor colorizer, IBlockAccess world, IBlockState state, BlockPos origin,
                              int x, int z, int colorIdx) {
        return colorizer.colorMultiplier(state, world, this.mpos.setPos(x, origin.getY(), z), colorIdx);
    }
