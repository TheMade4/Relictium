...
import io.themade4.relictium.core.client.gui.options.control.ControlElement;
import io.themade4.relictium.core.client.gui.options.storage.OptionStorage;
import io.themade4.relictium.core.client.gui.utils.Drawable;
import io.themade4.relictium.core.client.gui.utils.Element;
import io.themade4.relictium.core.client.gui.widgets.FlatButtonWidget;
...
public class RelictiumOptionsGUI extends GuiScreen {
    ...
    public RelictiumOptionsGUI(GuiScreen prevScreen) {
        super();

        this.prevScreen = prevScreen;

        this.pages.add(RelictiumGameOptionPages.general());
        this.pages.add(RelictiumGameOptionPages.quality());
        this.pages.add(RelictiumGameOptionPages.advanced());
        this.pages.add(RelictiumGameOptionPages.performance());
    }
    ...
    private void rebuildGUI() {
        ...
        if (RelictiumClientMod.options().notifications.hideDonationButton) {
